...
\emph{BS, Mathematics-Computer Science, Provost Honors} & \emph{June 2019}
\end{tabular*}
...
CSE 105 & \footnotesize Theory of Computability \\
CSE 170 & \footnotesize Interaction Design &
MATH 184 & \footnotesize Combinatorics and Graph Theory \\
...
\emph{Project Manager} & \emph{April 2018 to Present}
\end{tabular*}
\begin{itemize}[leftmargin=\listleftmargin, labelsep=\listlabelsep, itemsep=\listitemsep, label=\listbullet, topsep=\topsepsize]
	\small
	\item Let a team of software developers in developing a series of technical projects for social good.
	\item Created a structured lesson plan to teach team members web development with MEAN stack.
	\item Held weekly standups and meetings to discuss tasks; followed Agile methodology.
\end{itemize}
