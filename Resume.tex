...
\begin{itemize}[leftmargin=\listleftmargin, labelsep=\listlabelsep, itemsep=\listitemsep, label=\listbullet, topsep=\topsepsize]
	\small
	\item Responsible for the design and maintenance of the organization's website (sedsucsd.org) and internal content management system.
...
%	\item Set up a web server and local website to enable real-time monitoring of the Colossus system.
\end{itemize}
...
\begin{itemize}[leftmargin=\listleftmargin, labelsep=\listlabelsep, itemsep=\listitemsep, label=\listbullet, topsep=\topsepsize]
	...
	\item Pushing teams to adopt a more multidisciplinary approach with greater emphasis on human-centered design.
\end{itemize}
\vspace{\posthline}
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
