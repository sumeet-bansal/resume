...
\emph{BS, Mathematics-Computer Science, Provost Honors} & \emph{September 2016 to June 2020}
\end{tabular*}
...
\vspace{\posthline}
	\noindent\textbf{Skilled} -- Java, Python, SQL, MongoDB, JavaScript, jQuery, HTML, CSS, LaTeX, Git\\
	\noindent\textbf{Proficient} -- C, C++, Node.js, MATLAB, R, ARM Assembly
\end{document}